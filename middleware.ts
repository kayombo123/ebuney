...
export async function middleware(request: NextRequest) {
  try {
    ...
    try {
      ...
      // If Supabase client creation fails, return response without auth
      console.warn('Failed to create Supabase client in middleware:', error)
      return response
    }
    ...
    // If anything fails in middleware, return a basic response to prevent 500
